  ...
  <div class="community-container">
    <el-row :gutter="24">
      <el-col :span="16">
        <Publisher
          ref="publisherRef"
          :recommended-topics="recommendedTopicNames"
        ...
        <div class="feed-list">
          ...
          <transition-group name="list" tag="div">
            <PostItem
              ...
              :follow-loading-id="followLoadingId"
              @go-to-space="goToSpace"
              @follow="followAuthor"
              ...
              <div class="leaderboard-list">
                <div v-for="(hero, index) in leaderboard" :key="index" class="hero-item">
                  ...
                  <el-avatar
                    :size="32"
                    :src="hero.avatar"
                    :style="{ cursor: hero.userId ? 'pointer' : 'default' }"
                    @click="hero.userId && goToSpace(hero.userId)"
                  />
                  <div class="hero-name" :style="{ cursor: hero.userId ? 'pointer' : 'default' }" @click="hero.userId && goToSpace(hero.userId)">
                    {{ hero.name }}
                  </div>
...
.sticky-sidebar { position: sticky; top: 80px; align-self: start; transition: top 0.3s; }
